...
public class Main {
	...
	public static String createString(String str, int increment) {
		...
		//System.out.println("The string " + str + " and the final one" + finalString + "of the equation needs: " + r + " rights and " + d + " downs");
		//System.out.println("There is: " + realCountRight + " rights " + " and " + realCountDown + " downs" + "\n");
	...
	public static boolean CorrectPath(String str, int increment) {
		...
		for(int s = 0, i = 0, j = 0; s < str.length(); s++) {
		 ...
		 try {
			...
			//System.out.println("pa russkii itti damoy");
    	...
    	return truth; //(truth ? "We won" : changeString("We lost"));
	}
