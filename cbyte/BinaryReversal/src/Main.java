...
public class Main {
  ...
  public static String BinaryReversal(String int_str) {
	  ...
	  // Add the necessary 0's to the end so that the string has a length of 8 characters
	  for (int i = 1; i < 100; i++) {
	  ...
	  // Convert the StringBuilder back to a binary string, then decimal integer, then decimal string
